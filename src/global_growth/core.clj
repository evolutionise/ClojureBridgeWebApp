...
(defn get-population-density []
  ...
  (let [data (client/get "http://api.worldbank.org/countries/all/indicators/EN.POP.DNST?format=json&date=2010")
        response (json/parse-string (:body data) true)]
    response
  )
)
...
(get-indicator-values "EN.POP.DNST" 2014)
